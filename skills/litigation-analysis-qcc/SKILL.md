...
metadata:
  ...
  mcp-integrations: "qcc-risk, qcc-history, qcc-executive, qcc-company"
  industry: "Financial Services - Legal / Investment / Credit"
---
...
- 章节 1：**执行摘要 · Decision Pack** —— 一句话结论 + 关键判断表 + 推荐 Action（按 T+0 / T+3 / T+7 / T+14 / T+30 紧迫度排序） + 抗辩清单（预判质疑点）
